...
enum class OpCode : uint8_t {
    ...
    OP_ASSERT_BOOL, // peek 값이 논리가 아니면 예외 — &&/|| 피연산자 검사 (런타임 일관성 D4)
...
inline std::string opcodeName(OpCode op) {
    ...
    case OpCode::OP_GET_MEMBER:
        return "OP_GET_MEMBER";
    case OpCode::OP_SET_MEMBER:
        return "OP_SET_MEMBER";
    ...
    case OpCode::OP_SET_LOCAL_POP:
        return "OP_SET_LOCAL_POP";
    case OpCode::OP_SET_GLOBAL_POP:
        return "OP_SET_GLOBAL_POP";
    case OpCode::OP_SET_UPVALUE_POP:
        return "OP_SET_UPVALUE_POP";
    case OpCode::OP_SET_MEMBER_POP:
        return "OP_SET_MEMBER_POP";
    default:
        return "UNKNOWN";
    }
}
